...
def test_change_y_m_d():
    ...
    assert close_time(100, 200, arrow.get("2021-12-31T21:00")).format("YYYY-MM-DDTHH:mm") == arrow.get("2021-01-01T03:40").format("YYYY-MM-DDTHH:mm")

def test_control_gre_brev():
    # Test when the controle time is greater than the brevet length (but not by more than 20 percent)
    assert open_time(220, 200, arrow.get("2021-01-01T00:00")).format("YYYY-MM-DDTHH:mm") == arrow.get("2021-01-01T06:30").format("YYYY-MM-DDTHH:mm")
    assert close_time(220, 200, arrow.get("2021-01-01T00:00")).format("YYYY-MM-DDTHH:mm") == arrow.get("2021-01-01T14:40").format("YYYY-MM-DDTHH:mm")
